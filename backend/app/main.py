...
def bootstrap(
    ...
    return BootstrapResponse(
        ...
        problems=list_problems(category_id=None, search=None, session=session),
        assignments=list_assignments_for_user(session, current_user),
        submissions=list_submissions(problem_id=None, current_user=current_user, session=session, _cached_student_ids=student_ids),
        teachers=teachers,
